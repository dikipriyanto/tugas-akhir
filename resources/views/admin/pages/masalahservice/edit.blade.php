...
@section('content')
    <div class="card">
        <div class="card-body">
        <form action="{{ route('masalahupdate', $masalah->id) }}" method="post" >
            @csrf
                <div class="form-group">
                    <input type="hidden" class="form-control" value="{{$masalah->id}}" name="id">
                    <label for="">Nama Masalah</label>
                    <input type="text" class="form-control" value="{{$masalah->nama_masalah}}" name="nama_masalah">
                </div>
                <div class="form-group">
